...
const MatchCard = ({ match, isLive }) => {
    ...
    return (
        <div>
            <Link
                to={`/event/${match.id}`}
                className="group block relative bg-card rounded-xl overflow-hidden border border-white/5 hover:border-primary/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,255,148,0.1)] mb-4"
            >
                {/* Image Container */}
            ...
            {/* Banner Ad below each match card */}
            <div className="mb-4">
